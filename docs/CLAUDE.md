# SyncClass — Guia do projeto

Guia de referência rápida do projeto SyncClass para TCC.
...
| Skill | Focus |
|-------|-------|
| [**tcc-writing.md**](.claude/skills/tcc-writing.md) | Escrita acadêmica (FEPI/ABNT, voz impessoal, 10 capítulos, tradução código→texto) |
...
**Skills globais (TCC):** `tcc-fragmentos`, `tcc-rascunho`, `tcc-revisao-impessoal` — processo iterativo de drafting.
