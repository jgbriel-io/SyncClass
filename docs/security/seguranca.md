...
**IMPORTANTE**: Essas funções DEVEM ter `SECURITY DEFINER` para bypassar o RLS das próprias tabelas que consultam. Sem isso, ocorre recursão infinita e HTTP 500.
