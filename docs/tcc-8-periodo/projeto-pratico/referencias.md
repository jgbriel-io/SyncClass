...
- **Requisitos Funcionais:** 35 (30 implementados + 5 futuros)
  ...
  - RF31-RF33, RF35: Trabalhos futuros (fora do escopo do TCC)
  - RF34: ✅ Implementado (AbacatePay — Sprint 30)
...
- **Regras de Negócio:** 62 (59 originais + RN-060/061/062 AbacatePay Sprint 30)
- **Casos de Uso:** 26
...
| ---- | ----------------------------------------------------------------------------- | ------------ | --------------- |
| RF31 | Sistema de notificações (email, push, in-app)                                 | Notificações | Trabalho futuro |
| RF32 | Exportação de relatórios em PDF                                               | Relatórios   | Trabalho futuro |
| RF33 | Integração com Google Calendar                                                | Integrações  | Trabalho futuro |
| RF34 | Gateway de pagamento real (AbacatePay — PIX automático via QR Code + webhook) | Financeiro   | ✅ Sprint 30    |
| RF35 | Sistema de gamificação (badges, conquistas)                                   | Gamificação  | Trabalho futuro |
