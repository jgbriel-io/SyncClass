...
### Pagamento real — AbacatePay ✅ Implementado (Sprint 30)

- QR Code PIX via AbacatePay API; webhook confirma automaticamente
- **Próximo passo:** Suporte a múltiplos provedores (Stripe, Mercado Pago)
