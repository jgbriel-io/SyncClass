...
| Seção                     | Conteúdo                                                                |
| ------------------------- | ----------------------------------------------------------------------- |
| 6.1 Stack Tecnológica     | Supabase, shadcn/ui, TypeScript end-to-end, TanStack Query, Zod         |
| 6.2 Estrutura de Pastas   | src/ (~184 componentes, 34 hooks), pages/, lib/, supabase/              |
| 6.3 Padrões de Código     | Separação de responsabilidades, hook example, design tokens, strings UI |
| 6.4 Módulos Implementados | Alunos, Aulas, Financeiro, Atividades, Admin, Portal+Dashboard          |
| 6.5 Números do Projeto    | ~55.000 LOC, 181 componentes, 70 migrations, ~218 commits               |
