...
| Seção                              | Conteúdo                                                                 |
| ---------------------------------- | ------------------------------------------------------------------------ |
| 3.1 Classificação da Pesquisa      | Pesquisa aplicada, qualitativa+quantitativa, exploratória, pesquisa-ação |
| 3.2 Processo de Desenvolvimento    | Kanban/iterativo, branches, PRs, commits semânticos                      |
| 3.3 Uso de Inteligência Artificial | Ferramentas (Claude, Copilot), o que acelerou, o que não fez             |
| 3.4 Ferramentas e Tecnologias      | Stack completa com versões                                               |

### Citações Planejadas

- Thiollent (2011) — pesquisa-ação: ciclo planejamento→ação→observação→reflexão
- Tripp (2005) — critérios de pesquisa-ação
- Anderson (2010) — Kanban: justificativa para fluxo sem time-boxes
- Wohlin et al. (2012) — estudos de caso com sujeito único
- Pressman e Maxim (2016) — desenvolvimento iterativo incremental
- Peng et al. (2023) — referência base para estimativa de produtividade com IA

### Pendências Abertas

- [ ] Declarar explicitamente o protocolo de medição de H3 (unidade: horas; instrumento: estimativa calibrada em literatura; limitação: viés de retrospecto declarado)
- [ ] Decidir terminologia: "Kanban" ou "modelo iterativo incremental com fluxo contínuo"? Deve ser consistente com cap2 e cap8
- [ ] Remover duplicação com cap8: seção "O que a IA não fez" aparece em ambos — decidir onde fica
- [ ] Confirmar se "Claude via Kiro IDE" tem documentação oficial citável
