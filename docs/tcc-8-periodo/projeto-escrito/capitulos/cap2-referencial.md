...
| Seção                           | Conteúdo                                                                          |
| ------------------------------- | --------------------------------------------------------------------------------- |
| Introdução                      | Desafios da gestão autônoma, análise de soluções existentes, Quadro 1 comparativo |
| 2.1 Bases Tecnológicas          | SI (Laudon), SaaS/BaaS (NIST/Supabase), MVP (Ries, Pressman)                      |
| 2.2 Segurança, LGPD e Qualidade | LGPD, Privacy by Design, RLS, BOLA/IDOR, ISO/IEC 25010                            |
| 2.3 Metodologias e Inovação     | LLMs/IA (Peng et al.), ressalva de responsabilidade do engenheiro, ODS 4/8/9      |
...
- Peng et al. (2023) — 55% de ganho de produtividade (base comparativa para H3)
- Nações Unidas Brasil (2025) — ODS 4, 8 e 9

### Pendências Abertas

- [ ] Confirmar entrada ABNT de Lopes, Silva e Braga (2015) nas referências
- [ ] Verificar se (SUPABASE, 2024) está na lista de referências bibliográficas
- [ ] Quadro 1 já está no texto — confirmar formatação no Word (fonte 10, legenda centralizada)
- [ ] "Multilocação ✓ no SyncClass" no Quadro 1 — verificar se usar "Isolamento de dados por RLS" é mais preciso
