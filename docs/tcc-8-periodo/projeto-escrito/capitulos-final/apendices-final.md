...
## APÊNDICE F — Cronograma de Desenvolvimento

Este apêndice apresenta o cronograma de atividades do trabalho, que abrange o desenvolvimento do SyncClass, organizado em fases e iterações, e a redação do documento acadêmico, conduzida na etapa final do projeto. O cronograma deriva das fontes primárias contemporâneas descritas na seção 3.8, o histórico de versionamento do projeto: os 152 _commits_ com marcação temporal na _branch_ principal e as 70 _migrations_ SQL numeradas. O desenvolvimento ativo concentrou-se no período de março a junho de 2026, totalizando aproximadamente três meses.
...
### F.1 Fases do Desenvolvimento

As 31 iterações agruparam-se em cinco fases, definidas pela natureza predominante das entregas de cada período. O Quadro F.1 apresenta as fases, as iterações que as compõem, o período correspondente e as entregas principais.

**Quadro F.1 — Fases do desenvolvimento**
...
A Figura F.1 apresenta o diagrama de Gantt do desenvolvimento, que distribui as cinco fases ao longo dos aproximadamente três meses (março a junho de 2026). As fases de Fundação e Consolidação concentram-se em março e abril; a Expansão ocupa o período de abril a maio; as fases de Qualidade e segurança e de Estabilização encerram o ciclo em maio e junho. O diagrama inclui ainda a redação do trabalho acadêmico como atividade distinta do desenvolvimento, conduzida em paralelo às fases finais e concentrada no mês de junho de 2026, abrangendo a documentação dos resultados, a discussão das hipóteses e a revisão do texto para entrega.

**Figura F.1 – Diagrama de Gantt do desenvolvimento**
