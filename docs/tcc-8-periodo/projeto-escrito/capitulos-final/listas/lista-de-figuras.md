...
| Figura     | Título                                                | Pág. |
| ---------- | ----------------------------------------------------- | ---- |
| Figura 3.1 | Fluxo de desenvolvimento iterativo do SyncClass       | XX   |
| Figura 3.2 | Diagrama Entidade-Relacionamento do SyncClass         | XX   |
| Figura 3.3 | Definição da função is_admin() com SECURITY DEFINER   | XX   |
| Figura 4.1 | Tela de listagem de alunos (perfil professor)         | XX   |
