...
- **Tipagem:** TypeScript _end-to-end_ com tipos gerados automaticamente do banco via `supabase gen types`.
...
- CRUD completo com _soft delete_ e restauração de registros.
- Filtros dinâmicos por status, professor e aniversariantes.
- Paginação _server-side_ para lidar com grandes volumes de dados.
