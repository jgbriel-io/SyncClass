...
| **Cobertura de testes** | 32 testes unitários | `npm run test` |
| **Linhas de código (src/)** | ~46.400 | `cloc src/` |
| **Arquivos (src/)** | 391 | `find src/ -type f` |
| **Componentes React** | 187 | `find src/components/ -name "*.tsx"` |
| **Hooks customizados** | 42 | `find src/hooks/ -name "*.ts"` |
| **Páginas** | 24 | `find src/pages/ -name "*.tsx"` |
| **Migrations SQL** | 23 | `supabase/migrations/` |
