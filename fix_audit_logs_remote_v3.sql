-- =====================================================
-- CORREÇÃO: Sistema de Auditoria - Audit Logs (V3)
-- Data: 14/02/2026
-- Versão: 3.0 - Remove funções usando assinatura completa
-- =====================================================

-- IMPORTANTE: Execute o diagnostico_funcoes.sql primeiro
-- para ver as assinaturas exatas das funções

BEGIN;

-- =====================================================
-- PARTE 0: Remover funções usando assinatura completa
-- =====================================================

-- Remover mark_as_paid_idempotent com diferentes assinaturas
DO $$
DECLARE
    func_record RECORD;
BEGIN
    ...
    LOOP
        ...
        RAISE NOTICE 'Removida função: %', func_record.signature;
    END LOOP;
END $$;

-- Remover create_class_package com diferentes assinaturas
DO $$
DECLARE
    func_record RECORD;
BEGIN
...
-- Remover update_payment_day com diferentes assinaturas
DO $$
DECLARE
    func_record RECORD;
BEGIN
...
CREATE FUNCTION update_payment_day(
  p_student_id UUID,
...
CREATE FUNCTION mark_as_paid_idempotent(
  p_record_id UUID,
...
CREATE FUNCTION create_class_package(
