...
-- Data: 15/02/2026
-- Consolidado com Migrations 12-23 (24/02/2026)
-- ============================================
...
DROP VIEW IF EXISTS teachers_with_pix_restricted CASCADE;
...
CREATE TRIGGER trg_students_updated_at BEFORE UPDATE ON students
  FOR EACH ROW EXECUTE FUNCTION update_updORE UPDATE ON teachers
  FOR EACH ROW EXECUTE FUNCTION update_updated_at_column();
