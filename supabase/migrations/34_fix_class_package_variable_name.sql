-- BE-008: Rename v_financial_record_id used in the class_logs loop to v_inserted_log_id
-- to avoid semantic confusion — the loop variable stored class_log ids, not financial_record ids.
...
BEGIN
  ...
  FOREACH v_log IN ARRAY p_class_logs LOOP
    ...
    RETURNING id INTO STRICT v_inserted_log_id;
