export const dashboard = {
  ...
  metrics: {
    ...
    activeStudentsChangeSemester: "este semestre",
    activeStudentsChangeYear: "este ano",
    overdue: "Inadimplentes",
    overdueChange: (pct: string) => `${pct}% do total`,
    newThisMonth: "Novos este Mês",
    newThisSemester: "Novos este Semestre",
    newThisYear: "Novos este Ano",
    classesThisMonth: "Aulas este Mês",
    classesThisSemester: "Aulas este Semestre",
    classesThisYear: "Aulas este Ano",
  ...
  financial: {
    ...
    forecastedSemester: "Previsão Semestral",
    forecastedYear: "Previsão Anual",
