...
export const userRights = {
  ...
  rights: [
    { label: "Acesso", description: "Consultar seus dados pessoais armazenados" },
    { label: "Correção", description: "Atualizar dados incompletos ou incorretos" },
    { label: "Exclusão", description: "Solicitar a remoção de seus dados pessoais" },
    { label: "Portabilidade", description: "Receber seus dados em formato estruturado" },
    { label: "Revogação", description: "Retirar consentimento a qualquer momento" },
  ],
  notice:
...
export const dataRetention = {
  ...
  intro: "Em caso de solicitação de exclusão de dados, seguimos o seguinte procedimento:",
  sections: [
    {
