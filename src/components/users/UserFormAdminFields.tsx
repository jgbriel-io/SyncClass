  ...
  return (
    <div className="grid gap-4 sm:grid-cols-2">
      <div className="sm:col-span-2 space-y-2">
        ...
        <Input id="email" type="email" placeholder="admin@exemplo.com" {...register("email")} disabled={isLoading || isEdit} />
        {errors.email && <p className="text-sm text-destructive">{errors.email.message}</p>}
      </div>
      <div className="sm:col-span-2 space-y-2">
        <Label htmlFor="fullName">Nome completo *</Label>
        <Input id="fullName" placeholder="Nome do administrador" {...register("fullName")} disabled={isLoading} />
