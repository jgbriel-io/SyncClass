      ...
      <div className="p-6 space-y-6">
        <div className="grid grid-cols-3 gap-2">
          <div className="rounded-lg bg-success/10 p-3 text-center">
            ...
            <p className="text-xs text-muted-foreground">{common.labels.paid}</p>
          </div>
          <div className="rounded-lg bg-amber-500/10 p-3 text-center">
            <p className="text-sm font-bold text-amber-600">{formatCurrency(student.stats.totalPending)}</p>
            <p className="text-xs text-muted-foreground">{common.labels.pending}</p>
          </div>
          <div className="rounded-lg bg-rose-500/10 p-3 text-center">
            ...
            <p className="text-xs text-muted-foreground">{common.labels.overdue}</p>
          </div>
        </div>
