...
export function StudentDetailActivitiesTab({
  activities,
  activitiesLoading,
  onRefetch,
}: StudentDetailActivitiesTabProps) {
          ...
          <div className="space-y-3">
            {activities.map((activity) => (
              <Collapsible
                ...
                onOpenChange={(open) =>
                  setExpandedId(open ? activity.id : null)
                }
              >
                          ...
                          >
                            {expandedId === activity.id ? (
                              <>
                                ...
                                {common.labels.viewLess}
                              </>
                            ) : (
                              <>
                                <ChevronDown className="h-4 w-4" />
                                {common.labels.viewMore}
                              </>
                            )}
                          </Button>
                        </CollapsibleTrigger>
