import { TABLE_COLUMN_SIZES, calculateTableMinWidth } from "@/lib/design-tokens/table-columns";
...
export const TABLE_MIN_W = calculateTableMinWidth(['XL', 'M', 'S', 'M', 'S', 'S', 'S', 'S', 'XS']);
