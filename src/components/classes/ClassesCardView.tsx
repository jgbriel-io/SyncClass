...
import { Calendar, MoreHorizontal, Pencil, Trash2, Receipt, BookOpen, ChevronLeft, ChevronRight, Eye } from "lucide-react";
          ...
          <div className="flex flex-col sm:flex-row sm:items-start justify-between gap-4">
            <div className="flex items-start gap-4">
              ...
              <div className="space-y-2">
                ...
                {log.feedback && (
                  <p className="text-sm text-muted-foreground max-w-xl">{log.feedback}</p>
                )}
              </div>
            </div>
